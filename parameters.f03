MODULE parameters
  ...
  REAL            , PARAMETER :: STEPFAC     = 0.001                           ! Determines freq. between colls.
  REAL(KIND=DBL)  , PARAMETER :: TIME_TOTAL  = 1D7                         ! Total time in s
  ...
  ! Branching Ratios
  !******************************************************************************
  REAL            , PARAMETER :: O_O2_BRANCHING     = 0.7 ! For O + O2
  ...
  INTEGER, PARAMETER          :: TIME_FREQ    = 100000
